...
export const TOKEN_SWAP_STATE_ACCOUNT = new Web3.PublicKey(
  "EV7FEEq2EyTFtKx4ukp2QfW9mWLGcJckGGBNp5cjcHUe"
)
export const SWAP_POOL_AUTHORITY = new Web3.PublicKey(
  "24zqZMTYLVk4gm62seqU7KhBwvi3uBGtyDbnsC4rkbuR"
)

export const KRYPT_POOL_TOKEN_ACCOUNT = new Web3.PublicKey(
  "BVPUZrv5nk3jMyTWkZdxvp2LuyPF1DmGTyR8AzKvgZgN"
)
export const SCROOGE_POOL_TOKEN_ACCOUNT = new Web3.PublicKey(
  "5ttkBtMndCbHdSib22K4wRUE5ifprPXkMSckzBRSQv3K"
)

export const POOL_TOKEN_MINT = new Web3.PublicKey("CXQYDT9ShDYG1JMMwjNiR6TcL4u4uJNnguAbLKw6jVv4")
export const POOL_TOKEN_ACCOUNT = new Web3.PublicKey(
  "Fp1W1KHuakombQATnToDCSpTnqLicFEfxWgtCAWbuvCM"
)
export const POOL_TOKEN_FEE_ACCOUNT = new Web3.PublicKey(
...
export const AIRDROP_PROGRAM_ID = new Web3.PublicKey(
